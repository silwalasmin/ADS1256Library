...
class ADS1256{
public:
    ADS1256(spi_inst *spiNum, float clockSpeedMhz, float vRef, bool userResetPin,uint SCK,uint MISO,uint MOSI,uint pinCS,uint pinDRDY, uint pinRST);
